        ...
        return (
            <Well>
                <Grid>
                    ...
                    <Row>
                        <FieldGroup id='boxNumber' type='text' label='Box No.*' span={2} value={this.props.box['boxNumber']}
                            placeholder='12' onChange={this.updateBoxFormComponent} validation={this.validateComponent} />
                        <FieldGroup id='beginningRecordsDate' type='text' label='Start date of records*' span={2} value={this.props.box['beginningRecordsDate']}
                            placeholder='mm/dd/yyyy' onChange={this.updateBoxFormComponent} validation={this.validateComponent} />
                        <FieldGroup type='text' label='End date of records*' span={2} placeholder='mm/dd/yyyy' value={this.props.box['endRecordsDate']}
                            id='endRecordsDate' onChange={this.updateBoxFormComponent} validation={this.validateComponent} />
                        <FieldGroup type='select' label='Retention Function' span={2} placeholder='' value={this.props.box['retentionFunction']}
                    ...
                    <Row>
                        <FieldGroup type='select' label='Retention Category' span={2} placeholder='financial' value={this.props.box['retentionCategory']}
                        ...
                        <FieldGroup type='select' label='Permanent' span={2} placeholder='select y/n' value={this.props.box['permanent']}
                            options={[null, 'Yes', 'No']} id='permanent' onChange={this.updateBoxFormComponent} />
                        {
                            this.props.box['permanent'] === 'Yes'
                            ? (
                                <FieldGroup type='text' label='Permanent Review Period (years)' span={3} value={this.props.box['permanentReviewPeriod']}
                                    id='permanentReviewPeriod' onChange={this.updateBoxFormComponent} />
                            )
                            : ( <div>
                                    <FieldGroup type='text' label='Retention (years)' span={2} value={this.props.box['retention']}
                                        id='retention' onChange={this.updateBoxFormComponent} />
                                    <FieldGroup type='text' label='Review Date' span={2} placeholder='' value={this.props.box['reviewDate']}
                    ...
                    {/* Description */}
                    <Row>
                        <FieldGroup type='textarea' label='Description*' span={7} placeholder='description' value={this.props.box['description']}
